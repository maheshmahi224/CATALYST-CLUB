    ...
    <section id="team" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Our <span className="text-gradient">Team</span></h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((member, index) => (
            ...
            >
              <div className="relative h-60 overflow-hidden group">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center pb-4">
                  <div className="flex space-x-3">
                    <a href={member.social.linkedin} className="w-8 h-8 bg-white rounded-full flex items-center justify-center text-catalyst-blue hover:bg-catalyst-teal hover:text-white transition-colors">
                      <Linkedin size={18} />
                    </a>
                    <a href={member.social.github} className="w-8 h-8 bg-white rounded-full flex items-center justify-center text-catalyst-blue hover:bg-catalyst-teal hover:text-white transition-colors">
                      <Github size={18} />
                    </a>
                    <a href={member.social.email} className="w-8 h-8 bg-white rounded-full flex items-center justify-center text-catalyst-blue hover:bg-catalyst-teal hover:text-white transition-colors">
                      <Mail size={18} />
                    </a>
                  </div>
                </div>
              ...
              <div className="p-6">
                <h3 className="text-lg font-bold text-catalyst-blue">{member.name}</h3>
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 mb-4">Want to be part of our dynamic team?</p>
